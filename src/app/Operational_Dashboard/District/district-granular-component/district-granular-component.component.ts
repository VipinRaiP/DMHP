...
@Component({
  selector: 'app-district-granular-component',
  templateUrl: './district-granular-component.component.html',
  styleUrls: ['./district-granular-component.component.css'],
  providers: [
...
export class DistrictGranularComponentComponent implements OnInit {
