...
@Component({
  selector: 'app-taluka-granular',
  templateUrl: './taluka-granular.component.html',
  styleUrls: ['./taluka-granular.component.css'],
  providers: [
...
export class TalukaGranularComponent implements OnInit {
...
resolveChartParameter(parameterNumber: number) {
  ...
  if (parameterNumber == 1) {
    this.dataURL = {
      Annual: "getAlcoholDataTalukaAnnually",
      Quarter: "getAlcoholDataTalukaQuart",
      Monthly: "getAlcoholDataTalukaMonthly"
    }
    return {
    ...
    this.dataURL = {
      Annual: "getSuicideDataTalukaAnnually",
      Quarter: "getSuicideDataTalukaQuart",
      Monthly: "getSuicideDataTalukaMonthly"
    }
    return {
...
onSortByChange(event) {
  ...
  console.log("All Taluka: Sort by option changed");
  console.log(this.data);
...
onNormaliseChange(event) {
  ...
  console.log("All Taluka: Normalise option changed");
  console.log(this.data);
  if (this.data.length != 0) {
    this.normaliseData(this.normaliseChoosen);
    this.sendDataToChart();
