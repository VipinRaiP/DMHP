...
@Component({
  selector: 'app-district-map-details',
  templateUrl: './district-map-details.component.html',
  styleUrls: ['./district-map-details.component.css']
})
export class DistrictMapDetailsComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private mapService: DistrictMapService, public dialog: MatDialog) {
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(DistrictMapDialogComponent, {
      width: '1000px',
...
@Component({
  selector: 'district-map-dialog',
  templateUrl: 'district-map-dialog.html',
})
export class DistrictMapDialogComponent {
